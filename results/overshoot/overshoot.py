...
""" 
    This python script generates the .csv file for the 'overshoot' case 
    for the mobile robot simulation in CoppeliaSim. 
...
# Create .csv file
f1 = open("Overshoot_Traj.csv", "w") 
np.savetxt("Overshoot_Traj.csv", final_traj, delimiter = ",") 
...
print('Showing Plots --- Close plots to end program')
plt.show()
